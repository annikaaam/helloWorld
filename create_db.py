...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'annikam', 'email': 'annikam@umd.edu', 'first_name': 'Annika', 'last_name': 'Meng',
         'password': generate_password_hash('annikaspassword', method='pbkdf2:sha256'), 'role': 'STUDENT'},
